...
@section('title', 'Create Template Food Item')

@section('content')
<div class="min-h-screen bg-white">
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Create Template Food Item</h1>
            <p class="mt-1 text-sm text-gray-500">Add a new food item to a food suggestion template.</p>
        </div>
        ...
        <form action="{{ route('admin.template-food-items.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="number" step="0.01" name="suggested_quantity" value="{{ old('suggested_quantity') }}"
            ...
            <div>
                ...
                <input type="number" name="alternatives_group_id" value="{{ old('alternatives_group_id') }}"
