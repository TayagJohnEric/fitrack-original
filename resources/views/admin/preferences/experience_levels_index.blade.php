...
@section('title', 'Experience Levels Management')
@section('content')
<div class="min-h-screen bg-white">
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Manage Experience Levels</h1>
            <p class="mt-1 text-sm text-gray-500">Create and manage experience levels for users.</p>
        </div>
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-md mb-10 max-w-xl">
            <h2 class="text-xl font-semibold text-gray-800 mb-4">Add New Experience Level</h2>
            <form action="{{ route('admin.experience-levels.store') }}" method="POST" class="space-y-6">
                @csrf
                <div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($experienceLevels as $level)
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <form action="{{ route('admin.experience-levels.destroy', $level) }}" method="POST"
                                        onsubmit="return confirm('Are you sure you want to delete this experience level?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-4 text-center text-gray-500">No experience levels found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
