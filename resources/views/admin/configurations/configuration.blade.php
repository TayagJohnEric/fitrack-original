...
<div class="min-h-screen bg-white">
    ...
    <a href="{{ route('admin.activity-levels.index') }}" class="no-underline bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
        <div class="p-6">
            ...
            <div class="mt-4 flex items-center text-gray-600 group-hover:text-indigo-600 group-hover:translate-x-2 transition-transform duration-300">
    ...
    <!-- Fitness Goals Card -->
    <a href="{{ route('admin.fitness-goals.index') }}" class="no-underline bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
        <div class="p-6">
            <div class="flex items-center justify-between mb-4">
    ...
    <a href="{{ route('admin.experience-levels.index') }}" class="no-underline bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
        <div class="p-6">
            <div class="flex items-center justify-between mb-4">
    ...
    <!-- Workout Types Card -->
    <a href="{{ route('admin.workout-types.index') }}" class="no-underline bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
        <div class="p-6">
            <div class="flex items-center justify-between mb-4">
    ...
    <!-- Allergies Card -->
    <a href="{{ route('admin.allergies.index') }}" class="no-underline bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
        <div class="p-6">
            <div class="flex items-center justify-between mb-4">
